...
public class UserDataServiceImpl implements UserDataService{
    ...
    @Override
    public List<UserDto> getUsersByLoginOrEmail(String login, String email) {
        return userRepository.findByLoginOrEmail(login,email).stream().map(userConverter::convert).collect(Collectors.toList());
    }
}
